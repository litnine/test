<template>
  ...
  >
    ...
    <el-form-item
      ...
      prop="invite_code"
    >
      <el-input v-model="formModel.invite_code" />
    </el-form-item>
    <el-form-item
      class="t-c"
      label-width="0"
  ...
  setup(props, { emit }) {
    ...
    return {
      ...
      rules: {
        ...
        invite_code: [{ required: true, message: '必填项！', trigger: 'blur' }],
      },
    };
  },
});
