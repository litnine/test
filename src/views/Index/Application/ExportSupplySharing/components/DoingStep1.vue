<template>
  ...
  >
    ...
    >
      ...
      <span
        class="tip"
      >登录出口货源平台供货端的账号密码，18位以内，英文或数字组成</span>
    </el-form-item>
    <el-form-item
      label="确认密码"
      prop="rePassword"
    ...
    >
      <el-input
        ...
        class="input--inline"
      />
      <span class="tip">默认000000，有则填写</span>
    </el-form-item>
    <h4 class="form__section__title">
      平台信息
    </h4>
    ...
    >
      <el-input
        v-model="formModel.platform_name"
        class="input--inline"
      />
      <span
        class="tip"
      >在货源平台中面向采购商的使用简称，由中英文组成，如：披得供应链</span>
    </el-form-item>
    <el-form-item
      label="主营类目"
      prop="main_category"
    >
      ...
      <span
        class="tip"
      >在货源平台中主要供给的货源类目，如：家具、日用品等</span>
    </el-form-item>
    <h4 class="form__section__title">
      联系方式
    </h4>
